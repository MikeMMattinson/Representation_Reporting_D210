...
print('getFilename version: {}'.format('1.1'))
def getFilename(title: str, caption="XX",
             sect='XX', ftype = 'PNG',
...
print('saveTable version: {}'.format('1.2'))
def saveTable(data, title: str, caption="XX", 
              sect='XX',course='D209', 
              task='TASK1', title_only=False):
    """
    Construct a filename for given figure or table
    Input:
      data:
